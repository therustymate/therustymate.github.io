  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['therustymate/therustymate', 'therustymate/unofficial-projects'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
