    ...
    github: {
      ...
      automatic: {
        ...
        exclude: {
          ...
          projects: ["therustymate/blog", "therustymate/unofficial-projects", "therustymate/therustymate.github.io", "therustymate/therustymate"], // These projects will not be displayed. example: ['arifszn/my-project1', 'arifszn/my-project2']
        },
      },
      manual: {
